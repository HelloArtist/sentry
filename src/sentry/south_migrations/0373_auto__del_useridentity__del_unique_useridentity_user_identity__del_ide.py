...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'sentry_identity', ['idp_id', 'external_id'])

        # Removing unique constraint on 'IdentityProvider', fields ['type', 'instance']
        db.delete_unique(u'sentry_identityprovider', ['type', 'instance'])

        # Removing unique constraint on 'UserIdentity', fields ['user', 'identity']
        db.delete_unique(u'sentry_useridentity', ['user_id', 'identity_id'])

        # Deleting model 'UserIdentity'
        db.delete_table(u'sentry_useridentity')

        # Deleting model 'IdentityProvider'
        db.delete_table(u'sentry_identityprovider')
    ...
    def backwards(self, orm):
        ...
        db.create_unique(u'sentry_useridentity', ['user_id', 'identity_id'])

        # Adding model 'IdentityProvider'
        db.create_table(u'sentry_identityprovider', (
        ...
        db.create_unique(u'sentry_identityprovider', ['type', 'instance'])
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'c203a7b5eec64f8c96fe775a9586757492e9e7a96c3c4f589f696f6d361178e1'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'599b99dfa9444aa59300ee76fac29734df5c147bc17146c4a6df630056bb0063'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Together Flamingo'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'c4abec44ed314ec3b26cdcb0d6b7006f'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'689280ebc24c4ba88751e544c5c4a8021ed35d45d836409a9efed6b311b4a800'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': ('django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'cf43f381d8114375a0477787b5b766d35047ef0ae27447bcb8c581d68d8ad4e8'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0ec717f08c194a45a143471346ae65d1'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'51775dda1ce94cca8ddd5826ba909c7a'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.servicehook': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'829b3e1c615c40518694b18f4208092932456c669f754bb0a69c7e3ae397b278'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'5sHLQRfIxd1pwOag3TPJCBEL7SeZ2t79'", 'max_length': '32'})
        },
        'sentry.userip': {
